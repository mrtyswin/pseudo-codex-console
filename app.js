...
function renderPage(jobs, message) {
  ...
  return [
    ...
    '.queue-summary{display:flex;align-items:center;gap:7px;overflow:auto;padding:9px 20px;border-top:1px solid #eef2f7;background:#fbfcfe;white-space:nowrap}.queue-summary span{display:inline-flex;align-items:center;gap:5px;border:1px solid #e2e8f0;border-radius:999px;padding:4px 8px;background:#fff;color:#475569;font-size:.64rem}.queue-summary strong{color:#1e293b;font-weight:800}.empty{padding:48px 20px;text-align:center;color:#64748b}',
