...
function renderPage(jobs, message) {
  ...
  return [
    ...
    "</nav>",
    '<div class="server-status"><strong><span class="online-dot"></span>System online</strong><span>Ubuntu / ChatGPT dispatcher</span><span>Port 8090 · v0.1.1</span></div>',
    "</aside>",
    '<header class="topbar">',
    ...
    "</section>",
    "</main>",
    '<footer class="footer"><span>Pseudo Codex Console v0.1.1</span><span>3秒ごとに更新 · JST表示</span></footer>',
    "</div>",
    CLIENT_SCRIPT_TAG,
    CONSOLE_UI_SCRIPT,
    "</body>",
