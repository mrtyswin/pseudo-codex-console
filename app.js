...
'<div class="config-section-head"><h3>1. 基本設定</h3><p>ジョブをどこで、どの方式で実行するかを指定します。同じプロジェクト名で保存すると既存設定を更新します。</p></div>',
'<div class="project-config-grid">',
'<div><label for="project-config-name">プロジェクト名 <span class="field-required">必須</span></label><input id="project-config-name" name="name" maxlength="64" placeholder="wordpress-demo" required><small class="field-help">新規名なら追加、登録済みと同じ名前なら上書き更新します。</small></div>',
...
'<div><label for="project-config-workspace">Workspace <span class="field-required">必須</span></label><input id="project-config-workspace" name="workspace" maxlength="500" placeholder="/home/ubuntu/chatgpt-projects/wordpress-demo" required><small class="field-help">Ubuntu上で対象コードを読み書きするプロジェクトディレクトリです。</small></div>',
'</div>',
...
'</section>',
'<section class="config-section">',
'<div class="config-section-head"><h3>2. 本番反映・動作確認</h3><p>デプロイが必要なプロジェクトだけ入力します。ローカル編集のみなら空欄のままで構いません。</p></div>',
'<div class="project-config-grid">',
'<div><label for="project-config-health">Health URL <span class="field-optional">任意</span></label><input id="project-config-health" name="healthUrl" maxlength="500" placeholder="http://127.0.0.1:8080/health"><small class="field-help">デプロイ後に稼働確認するURLです。</small></div>',
'<div><label for="project-config-production">Production Root <span class="field-optional">任意</span></label><input id="project-config-production" name="productionRoot" maxlength="500" placeholder="/opt/pseudo-codex-console"><small class="field-help">本番で実際に動作する配置先です。</small></div>',
'<div><label for="project-config-service">Service / Container <span class="field-optional">任意</span></label><input id="project-config-service" name="service" maxlength="300" placeholder="pseudo-codex-console.service"><small class="field-help">再起動・状態確認の対象名です。</small></div>',
'<div><label for="project-config-deploy">Deploy Command <span class="field-optional">任意</span></label><input id="project-config-deploy" name="deployCommand" maxlength="500" placeholder="/usr/local/libexec/pseudo-codex-deploy-request-console"><small class="field-help">検証成功後に実行する本番反映コマンドです。</small></div>',
'<div><label for="project-config-verify">Verify Command <span class="field-optional">任意</span></label><input id="project-config-verify" name="verifyCommand" maxlength="500" placeholder="/usr/local/lib/pseudo-codex-console-deploy/verify-live.js"><small class="field-help">デプロイ後に本番状態を確認するコマンドです。</small></div>',
'<div><label for="project-config-owner">Deployment Owner <span class="field-optional">任意</span></label><input id="project-config-owner" name="deploymentOwner" maxlength="100" placeholder="host_dispatcher"><small class="field-help">デプロイを実行する担当プロセスです。</small></div>',
'</div>',
'<div class="checkbox-row"><label><input type="checkbox" name="requiresDeployment" value="true"> 検証成功後に本番反映を実行する</label></div>',
'</section>',
'<section class="config-section">',
'<div class="config-section-head"><h3>3. GitHub / Git 運用</h3><p>Git管理するプロジェクトだけ有効にします。成功後のpushや作業ブランチの作り方を指定します。</p></div>',
...
'<div class="project-config-grid">',
'<div><label for="project-config-repository">GitHub Repository <span class="field-optional">Git使用時</span></label><input id="project-config-repository" name="gitRepository" maxlength="300" placeholder="owner/repository"><small class="field-help">GitHub上の owner/repository を指定します。</small></div>',
'<div><label for="project-config-remote">Git Remote <span class="field-optional">Git使用時</span></label><input id="project-config-remote" name="gitRemote" maxlength="200" value="origin"><small class="field-help">通常は origin のままで構いません。</small></div>',
...
'</div>',
'<p class="helper">pushにはUbuntu側のGit author設定とGitHub認証を使用します。</p>',
'</div>',
'</section>',
